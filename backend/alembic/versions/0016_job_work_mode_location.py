"""jobs: add work_mode (remote/onsite/hybrid) and location

Revision ID: 0016
Revises: 0015
Create Date: 2026-08-26

Both nullable — null work_mode means "not specified", not shown/filtered
as any particular mode on the public board.
