"""jobs: add optional salary (fixed or range)

Revision ID: 0018
Revises: 0017
Create Date: 2026-08-26

salary_max null + salary_min set = fixed figure; both set = range;
neither set = not disclosed. No separate salary_type enum needed.
